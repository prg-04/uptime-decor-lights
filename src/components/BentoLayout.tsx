...
import chandelier from '@/public/chandelier_1.jpeg'
...
const FeatureCard = ({
  ...
  return (
    <div className={cn(`p-4 sm:p-8 `, className)}>
      {children}
      {image && (
        <Image src={image} alt="chandelier" className="w-full h-full object-cover" />
      )}
    </div>
  )
}
...
export const SkeletonOne = () => {
  return (
    // <div className="flex py-2 px-2 gap-10 h-full">
